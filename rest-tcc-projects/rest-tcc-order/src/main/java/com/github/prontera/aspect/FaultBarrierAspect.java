    ...
    public Object aroundMethod(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            if (e instanceof ResolvableStatusException) {
                final StatusCode statusCode = ((ResolvableStatusException) e).getStatusCode();
                ...
                proceed = Responses.generate(ResolvableResponse.class, statusCode, message);
            } else if (e instanceof InvalidModelException) {
                proceed = Responses.generate(ResolvableResponse.class, StatusCode.INVALID_MODEL_FIELDS, e.getMessage());
            } else {
                ...
                proceed = Responses.generate(ResolvableResponse.class, unknownException);
            }
        }
        return proceed;
    }
