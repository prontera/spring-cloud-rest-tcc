...
public enum StatusCode implements NumericStatusCode {
     ...
     * 用户名被重复注册
     */
    PRODUCT_REGISTERED(40002, "产品名已被注册"),

    /**
     * 产品不存在
     */
    PRODUCT_NOT_EXISTS(40003, "产品不存在"),
     ...
     * 库存不足
     */
    INSUFFICIENT_INVENTORY(42002, "库存不足"),
     ...
     */
    NON_RESERVING_STATE(50005, "资源已处于final state"),

    /**
     * 当预留资源过期后, 回滚库存失败, 可由于CP异常导致
     */
    ACCOUNT_ROLLBACK_FAILURE(50006, "库存增加失败, 已回滚事务"),
