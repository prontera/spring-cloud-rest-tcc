package com.github.prontera.common.config.aop;

import com.github.prontera.common.RequestLogging;
import com.github.prontera.common.config.RequestAttributeConst;
import com.github.prontera.common.web.RequestDetailsLogger;
import com.github.prontera.common.web.ResponseDetailsLogger;
import com.github.prontera.common.web.ServletContextHolder;
...
public class RequestLoggingAspect implements Ordered {
    ...
    @Around(value = "within(com.github.prontera..*) " +
            ...
            "&& @annotation(com.github.prontera.common.RequestLogging)")
