...
(
    ...
    `heartbeat_at` DATETIME            NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '当前leader的最后心跳时间 - UTC',
...
(
    ...
    `heartbeat_at`  DATETIME            NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '心跳时间 - UTC',
    PRIMARY KEY (`id`),
...
(
    ...
    `update_at`         DATETIME            NOT NULL COMMENT '修改时间 - UTC',
    `expire_at`         DATETIME            NOT NULL COMMENT '失效时间 - UTC',
    `done_at`           DATETIME            NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '完成时间 - UTC',
    PRIMARY KEY (`id`),
